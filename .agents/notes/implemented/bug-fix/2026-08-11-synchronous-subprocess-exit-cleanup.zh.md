...
listener无法覆盖不执行 JavaScript的故障，也无法发现 provider首次观察前已经逃逸的 terminal后代。native ordinary-process ownership 由[containment decision](2026-08-20-subprocess-native-containment.md)说明；PTY ownership 仍是独立边界。
