...
- **Preset-independent host state** — switching an active session to `minimal` leaves its host-owned goal intact; `/goal` and goal tools disappear, while the strip still lets the user edit, pause, resume, or clear the goal.
