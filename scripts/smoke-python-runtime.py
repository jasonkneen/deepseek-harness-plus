...
def main() -> None:
    ...
    parser.add_argument(
        "--scenario",
        choices=("all", "sdk-default", "sdk-custom", "sdk-minimal", "sdk-fs-search", "sdk-mcp", "sdk-snapshot", "sdk-restart", "sdk-profile-plugin", "sdk-live", "runner", "direct"),
        default="all",
    )
    ...
    if args.scenario in {"all", "sdk-custom", "sdk-minimal", "sdk-fs-search", "sdk-snapshot", "sdk-restart", "runner", "direct"} and args.exe is None:
        parser.error("--exe is required for custom, minimal, fs-search, snapshot, restart, runner, and direct scenarios")
