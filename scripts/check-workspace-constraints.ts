...
const appPackageFiles: Readonly<Record<string, readonly string[]>> = {
  ...
  // The desktop app ships its compiled main process plus the packaging
  // metadata (builder config, entitlements). Sourcemaps stay out of the payload.
  '@deepseek-ai/dsh-desktop': ['lib', '!lib/**/*.map', 'electron-builder.yml', 'build'],
}
