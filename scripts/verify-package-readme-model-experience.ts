...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bundle/multi-provider': { kind: 'indirect', reason: 'The bundle is a patch-list carrier; each inserted row\'s package owns its model-facing behavior.' },
  ...
  'packages/examples/engine-session-demo': { kind: 'indirect', reason: 'The composed delegation backend owns the engine-visible task; the bin adds no model-bound text.' },
  'packages/examples/multi-provider-demo': { kind: 'indirect', reason: 'The composed spine and provider pack own the model-visible request; the bin adds no model-bound text.' },
